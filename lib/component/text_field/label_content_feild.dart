...
class LabelContentFeild extends StatefulWidget {
  const LabelContentFeild({
    super.key,
    this.controller,
    this.enabled = true,
    this.initialValue,
  ...
  @override
  State<LabelContentFeild> createState() => _LabelContentFeildState();
}

class _LabelContentFeildState extends State<LabelContentFeild> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Content(data: widget.labelText ?? '', textStyle: widget.labelStyle ??
            ...
            suffixIcon: isPassword
                ? GestureDetector(
                    ...
                    child: SvgPicture.asset(
                      ...
                      theme: SvgTheme(currentColor: AppColor.primary),
                    ).paddingAll(14.h),
                  )
                : widget.suffixIcon,
